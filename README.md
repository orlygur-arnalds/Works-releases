...
The music that emerges from this work is almost an afterthought—secondary to the process of exploring these curiosities. When it comes time to compose a piece from these patches, I quickly lose interest. 
In that sense, these tracks are hardly composed in the traditional way. Their structure arises entirely from their process of production. Their development in time is simply a byproduct of how these sounds came into being.


The captivating sense of discovery vanishes, and my role shifts to organizing sound linearly in time.
